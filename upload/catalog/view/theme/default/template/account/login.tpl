      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="well">
            ...
            <a href="<?= $router->link('account/register', '', 'SSL') ?>" class="btn btn-primary"><?= $lng->get('button_continue') ?></a></div>
        </div>
        <div class="col-sm-6">
          <div class="well">
            <h2><?= $lng->get('text_returning_customer') ?></h2>
            <p><strong><?= $lng->get('text_i_am_returning_customer') ?></strong></p>
            <form action="<?= $router->link('account/login', '', 'SSL') ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <a href="<?= $router->link('account/forgotten', '', 'SSL') ?>"><?= $lng->get('text_forgotten') ?></a></div>
